...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/chillui/chill-ui.git
   ```
...
```tsx
import { ComponentName } from 'chillui'; // or 'chillui-native'
...
- 💬 [GitHub Discussions](https://github.com/chillui/chill-ui/discussions)
- 🐛 [GitHub Issues](https://github.com/chillui/chill-ui/issues)
