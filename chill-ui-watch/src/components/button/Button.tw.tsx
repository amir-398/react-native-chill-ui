// NativeWind optimized version - Generated automatically
// This file uses pure Tailwind classes without runtime style detection
// For maximum performance with NativeWind
 ...
 */
const TouchableComponent = forwardRef<any, PropsWithChildren<BtnProps>>(
 ...
 return (
 <RipplePressable {...commonProps} className={className} style={style}>
 {children}
 </RipplePressable>
 );
 ...
 case 'RipplePressable':
 return (
 <RipplePressable {...commonProps} style={style}>
 {children}
 </RipplePressable>
 );
 ...
 * Optimized for NativeWind - uses pure Tailwind CSS classes for maximum performance.
 *
 * @example
 * ```tsx
 * // Basic usage
 ...
 */
const Button = forwardRef<any, PropsWithChildren<BtnProps>>((props, ref) => { const {
 children,
 className,
