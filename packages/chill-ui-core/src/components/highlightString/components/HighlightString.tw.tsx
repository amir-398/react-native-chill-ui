...
/**
 * The `<HighlightString />` component provides a high-level text component with predefined styling variants.
 *
 ...
 */
export function HighlightStringImpl(props: HighlightStringPropsTw) {
  const {
    className,
    content,
    highlightClassName,
