...
export const AutocompleteContext = createContext<IAutocompleteDropdownContext>({
...
export function AutocompleteDropdownContext({ children, headerOffset = 0 }: IAutocompleteDropdownContextProviderProps) {
  ...
  const registerInstance = useCallback(
    (id: string, inputContainerRef: RefObject<View | null>, offsetX?: number, offsetY?: number) => {
      setInstances(prev => {
