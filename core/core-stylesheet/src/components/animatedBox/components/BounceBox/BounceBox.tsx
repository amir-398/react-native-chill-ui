...
import type { BounceBoxProps, BounceBoxRef } from '../../../../types/bounceBox.types';
 ...
 * <BounceBox autoStart infiniteLoop bounceHeight={15} style={{ backgroundColor: 'red', padding: 16, borderRadius: 20 }}>
 ...
 *   bounceInterval={1500}
 *   infiniteLoop
 *   style={{ backgroundColor: 'orange', padding: 12, borderRadius: 8 }}
 * >
 *   <Icon name="bell" style={{ color: 'white' }} />
 * </BounceBox>
 * ```
 *
