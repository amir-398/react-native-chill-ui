...
import { TimePickerScrollerPropsSs } from '@types';
 ...
 * @param style - StyleSheet styles for the container
 * @returns Animated scrolling picker component
 */

export function TimePickerScroller(props: PropsWithChildren<TimePickerScrollerPropsSs>) {
  const {
    children,
